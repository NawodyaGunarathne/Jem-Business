...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total"> grand total : Rs<?= $total; ?>/- </span>
   </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. waththa para" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="e.g. Sri Lamka" name="country" required>
         </div>
         <div class="inputBox">
            <span>pin code</span>
